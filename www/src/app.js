    ...
    $ionicPlatform.ready(function () {
        ...
        $rootScope.famille = [
            ...
            $rootScope.ficheAccident = [
                {id : "17.1A", vecA : 1, vecB : 0,total_A : 1, total_B : 0, commentaire : "Sauf s'il est en double file ou au milieu de la chaussée, un véhicule en stationnement n'a pas une part active dans un accident, la position de l'autre véhicule importe peu puisqu'il est nécessairement en mouvement", obs_a : "", obs_b:"", obs_nota:""},
                {id : "17.1.1A", vecA : 1, vecB : 0, total_A : 1, total_B : 0, commentaire : "S'il est en double file ou au milieu de la chaussée, un véhicule en stationnement prend une une part passive dans un accident, la position de l'autre véhicule importe peu puisqu'il est nécessairement en mouvement", obs_a : "J'étais arrêté en double file", obs_b:"Le véhicule A était en double file",  obs_nota:""},
                {id : "17.1B", vecA : 1, vecB : 0, total_A : 1, total_B : 0,commentaire : "Un véhicule est à l'arrêt régulier lorsque son conducteur est au volant et que le véhicule ne bouge pas, par exemple, à l'arrêt à un feu rouge Le conducteur A peut entourer la mention \"à l'arrêt\" dans la zone 12 ou indiquer \"à l'arrêt\" en observations Par contre, si le véhicule est à l'arrêt irégulier, il faut utiliser le cas N° 17.1.1.A", obs_a : "", obs_b:"",  obs_nota:""},
                {id : "17.1C", vecA : 1, vecB : 0, total_A : 1, total_B : 0,commentaire : "Aucun commentaire", obs_a : "", obs_b:"",  obs_nota:""},
                {id : "17.1D", vecA : 1, vecB : 0, total_A : 1, total_B : 0,commentaire : "Sauf s'il est en double file ou au milieu de la chaussée, un véhicule en stationnement le long d'un trottoir en agglomération n'a pas une part active dans un accident, même s'il est en stationnement interdit, devant une porte cochère, dans un angle, même devant un commissariat. Cela vous étonne, certains vont en faire une crise cardiaque, mais c'est ainsi !", obs_a : "", obs_b:"", obs_nota:"Si le conducteur du véhicule tamponneur veut mettre en observations que le véhicule A était en stationnement gênant ou interdit, inutile de discuter, laissez le faire, cela ne changera absolument rien du moment que les croix sont placées dans les cases comme sur l'exemple "},
                 {id : "17.1C", vecA : 1, vecB : 0, total_A : 1, total_B : 0,commentaire : "S'il est en panne ou accidenté sur la chaussée et qu'il est dûment signalé, un véhicule n'a qu'un rôle passif dans l'accident, la position de l'autre véhicule importe peu puisqu'il est nécessairement en mouvement", obs_a : "j'étais en panne avec un triangle de signalisation ", obs_b:"",  obs_nota:""}
                ];
